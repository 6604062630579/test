  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_BACKEND_URL}/api/employee/registerStaff`,
        formData,
        { headers: { token } }
      );
  ...
  return (
    <div className="w-full flex flex-col items-center text-Text p-2 sm:p-8">
      ...
      <form
        ...
        className="grid h-full w-full grid-cols-1 lg:grid-cols-4 gap-4 mt-4"
      >
        {/* 1 Section */}
        <div className="cols-span-4 lg:col-span-3 grid rounded-xl gap-3">
            ...
            <div className="flex gap-4 w-full mb-4">
              <div className="w-full">
                ...
                <input
                  ...
                  value={firstname}
                  type="text"
                  className="w-full rounded-lg p-2 bg-Text/20 placeholder-Text/50"
          ...
          <div className="rounded-xl bg-BG flex flex-col items-center justify-center p-5">
            <h1 className="text-2xl font-bold self-start mb-5">
              Address Information
            </h1>
            <div className="w-full mb-4">
              ...
              <select
                ...
                value={country}
                className="w-full rounded-lg p-2 bg-Text/20 text-Text/80 placeholder-Text/50"
              >
                <option value="" disabled className="text-BG/80">
                  Select a country
                </option>
                <option
                  value="THA"
                  className="bg-BG text-Text/90 hover:bg-Text/30"
                >
                  Thailand
                </option>
                <option
