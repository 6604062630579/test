          ...
          <div className="flex pt-20">
            ...
            >
              <Routes>
                ...
                <Route
                  path="/create"
                  element={<CreateMenu token={token} role={role} />}
                />
                <Route
                  path="/edit_menu/:productId"
                  element={<EditMenu token={token} role={role} />}
                />
                <Route path="/analytics" element={<Analytics role={role} />} />
                <Route
                  path="/add_employee"
                  element={<AddEmployee token={token} role={role} />}
                />
                <Route
                  path="/edit_employee/:staffId"
                  element={<EditEmployee token={token} role={role} />}
                />
                <Route
                  path="/list_employee"
                  element={<Employee token={token} role={role} />}
                />
                <Route
                  path="/login"
